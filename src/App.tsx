        ...
        <NavLink to="/dashboard"
          ...
          {({ isActive }) => (
            <>
              ...
              <span className={`text-[10px] font-semibold ${isActive ? 'text-white' : 'text-zinc-500'}`}>Stats</span>
            </>
          )}
        </NavLink>
        ...
        <NavLink to="/shuffle"
          ...
          {({ isActive }) => (
            <>
              ...
              <span className={`text-[10px] font-semibold ${isActive ? 'text-white' : 'text-zinc-500'}`}>Shuffle</span>
            </>
          )}
        </NavLink>
      </nav>
